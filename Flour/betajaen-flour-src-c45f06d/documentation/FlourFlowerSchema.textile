...
p. Comments may take up an entire line or be placed within a line. A comment is prefixed with the @#@ character. Once the @#@ character is read, the rest of the line is ignored. Line and inline comments may use unicode.
...
p. **Version**: 0.25, **Last modified**; 03-June-2010, **Authors:** Robin Southern